...
export const routePermissions: Record<string, UserRole[]> = {
  ...
  "/dashboard/avaliacoes": ["admin", "secretario", "professor", "estudante"],
  "/dashboard/propinas": ["admin", "secretario"],
  "/dashboard/propinas/historico": ["admin", "secretario"],
  "/dashboard/horarios": ["admin", "secretario", "professor", "estudante"],
  "/dashboard/comunicados": ["admin", "secretario", "professor"],
  "/dashboard/relatorios": ["admin", "secretario"],
